...
export function OnboardingDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-w-2xl border border-gray-200 bg-white text-gray-900 shadow-2xl sm:rounded-3xl">
        <div className="space-y-6">
          <DialogHeader className="space-y-4">
            <div className="inline-flex items-center gap-2 rounded-full bg-gray-100 px-3 py-1 text-xs font-medium text-gray-500 ring-1 ring-gray-200">
              <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
              Découvrir Jumble
            </div>
            <DialogTitle className="text-left text-2xl font-semibold tracking-tight sm:text-3xl">
            ...
            <DialogDescription className="text-left text-sm leading-relaxed text-gray-600">
              Jumble est un espace libre où vous déposez tout ce qui compte pour vous : textes, liens, captures,
              tâches, inspirations… Glissez, zoomez, et composez votre propre cartographie mentale, sans contrainte de grille.
            </DialogDescription>
          </DialogHeader>

          <div className="grid gap-4 rounded-2xl bg-gray-50 p-4 ring-1 ring-gray-100 sm:grid-cols-3">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <DialogFooter className="sm:justify-end gap-2">
              <Button
                size="sm"
                variant="outline"
                className="border-gray-200 bg-white text-xs text-gray-700 hover:bg-gray-50"
                onClick={handleClose}
              >
                Explorer plus tard
              </Button>
